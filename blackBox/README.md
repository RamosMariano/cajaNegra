...
[Documento de Arquitectura del Simulador](./Documento_ConfigSim.md)
...
Opción 2 :  
[Endpoints Swagger](https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/RamosMariano/simulatorV3/v2/IoTEste_Swagger.yml)

---

## Uso del simulador
*(Texto placeholder: explicar acá que hacer para ejecutar)*

### Comandos de ejecución
```bash
# Placeholder - ejecutar simulación
comando_simulador --iniciar

# Placeholder - mostrar resultados
comando_simulador --ver-resultados
